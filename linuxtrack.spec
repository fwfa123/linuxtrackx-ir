...
echo "  1. Add your user to device access groups:"
echo "     sudo usermod -a -G plugdev,input,uinput,video \$USER"
echo "     (TrackIR/PS3 Eye: plugdev + udev rules; Mickey: uinput; webcams: video group)"
