...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LtrDevHelp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LtrDevHelp_t qt_meta_stringdata_LtrDevHelp = {
    {
QT_MOC_LITERAL(0, 0, 10), // "LtrDevHelp"
QT_MOC_LITERAL(1, 11, 26), // "on_DumpPrefsButton_pressed"
...
QT_INIT_METAOBJECT const QMetaObject LtrDevHelp::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_LtrDevHelp.data,
