...
//mfc42u.dll is needed by TIRViews.dll (Visual C++ 6.0)
class Mfc42uWinetricksExtractor : public Extractor
{
 Q_OBJECT
 public:
  Mfc42uWinetricksExtractor(QWidget *parent = 0);
  ~Mfc42uWinetricksExtractor();
 ...
 private:
  ...
  // Winetricks and extraction methods
