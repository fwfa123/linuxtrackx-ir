...
bool ltr_int_get_pose(double rp0[3], double rp1[3], double rp2[3], double c_base[3],
  double center[3], double tr[3][3], double angles[3], double trans[3], double abs_pos[3], double abs_angles[3]);

static dbg_flag_type pts_dbg_flag = DBG_CHECK;
