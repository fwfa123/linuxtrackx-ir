...
Section "Linuxtrack / TrackIR Interface"
  SectionIn RO
  SetOutPath $INSTDIR
  File /oname=Controller.exe controller\Controller.exe
  File /oname=Tester.exe tester\Tester.exe
  File /oname=Tester64.exe tester\Tester64.exe
  File /oname=NPClient.dll client\NPClient.dll
  File /oname=NPClient64.dll client\NPClient64.dll
  File /oname=check_data.exe client\check_data.exe
  File /oname=linuxtrack.ico .\controller\linuxtrack.ico
  File /oname=TrackIR.exe views\TrackIR.exe
...
Section "Linuxtrack / Freetrack Interface"
  SetOutPath $INSTDIR
  File /oname=FreeTrackTester.exe ft_tester\ftc.exe
  File /oname=FreeTrackClient.dll ft_client\FreeTrackClient.dll
