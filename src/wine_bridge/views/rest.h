...
// Exact match after normalizing catalog name the same way as GUI aliases (lowercase,
// punctuation/parens to spaces, collapsed). Avoids fuzzy "operation flashpoint" -> OF2.
