...
Download the AppImage from this release and make it executable:
...
**Full Changelog**: See [CHANGELOG.md](https://gitlab.com/fwfa123/linuxtrackx-ir/-/blob/main/CHANGELOG.md) for complete history.
